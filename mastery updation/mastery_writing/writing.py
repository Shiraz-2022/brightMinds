...
def predict_new_wmastery(new_data):
    ...
    loaded_model = keras.models.load_model('mastery_model_writing.h5')
    # Load the saved ColumnTransformer
    loaded_ct = joblib.load('column_transformer_writing.pkl')

    read_type_map = {'Letter Writing': 'W1', 'Word Writing': 'W2', 'Sentence Writing': 'W3'}
...
# Get the prediction
predicted_score = predict_new_wmastery(new_data)
